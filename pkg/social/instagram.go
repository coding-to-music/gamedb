...
func UploadInstagram() {
	...
	operation := func() (err error) {
		...
		_, err = ig.UploadPhoto(resp.Body, app.GetName()+" (Score: "+helpers.FloatToString(app.ReviewsScore, 2)+") https://gamedb.online/apps/"+strconv.Itoa(app.ID)+" #steamgames #steam #gaming "+pkg.GetHashTag(app.GetName()), 0, 0)
		return err
	}
