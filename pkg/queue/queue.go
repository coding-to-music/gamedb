...
var (
	...
	AllProducerDefinitions = []QueueDefinition{
		...
		{name: QueueAppsAchievementsSearch, prefetchSize: 5000},
		{name: QueueAppsArticlesSearch, prefetchSize: 5000},
		...
		{name: QueueGroupsSearch, prefetchSize: 5000},
		{name: QueuePackages},
		...
		{name: QueueAppsSearch, prefetchSize: 5000},
	...
	ConsumersDefinitions = []QueueDefinition{
		...
		{name: QueueAppsAchievementsSearch, consumer: appsAchievementsSearchHandler, prefetchSize: 5000},
		{name: QueueAppsArticlesSearch, consumer: appsArticlesSearchHandler, prefetchSize: 5000},
		...
		{name: QueueGroupsSearch, consumer: groupsSearchHandler, prefetchSize: 5000},
