...
var (
	...
	AllProducerDefinitions = []QueueDefinition{
		...
		{name: QueueAppsAchievementsSearch, prefetchSize: 10_000},
		{name: QueueAppsAchievements},
		{name: QueueAppsArticlesSearch, prefetchSize: 10_000},
		{name: QueueAppsDLC},
		...
		{name: QueueAppsSearch, prefetchSize: 10_000},
		...
		{name: QueueGroupsSearch, prefetchSize: 10_000},
		{name: QueueGroups},
		...
		{name: QueuePlayersSearch, prefetchSize: 10_000},
	...
	ConsumersDefinitions = []QueueDefinition{
		...
		{name: QueueAppsAchievementsSearch, consumer: appsAchievementsSearchHandler, prefetchSize: 10_000},
		{name: QueueAppsArticlesSearch, consumer: appsArticlesSearchHandler, prefetchSize: 10_000},
		...
		{name: QueueAppsSearch, consumer: appsSearchHandler, prefetchSize: 10_000},
		...
		{name: QueueGroupsSearch, consumer: groupsSearchHandler, prefetchSize: 10_000},
		...
		{name: QueuePlayersSearch, consumer: appsPlayersHandler, prefetchSize: 10_000},
