            ...
            "columnDefs": [
                // Icon / Name
                {
                    ...
                    "render": function (data, type, row) {
                        return '<div class="icon-name"><div class="icon"><img data-lazy="' + row[2] + '" class="rounded square" data-lazy-alt="' + row[1] + '"></div><div class="name">' + row[1] + '</div></div>'
                    },
        ...
        const dt2 = $('#games #recent-games').DataTable($.extend(true, {}, dtDefaultOptions, {
            ...
            "columnDefs": [
                // Icon / Name
                {
                    "targets": 0,
                    "render": function (data, type, row) {
                        return '<div class="icon-name"><div class="icon"><img data-lazy="' + row[1] + '" class="rounded square" data-lazy-alt="' + row[2] + '"></div><div class="name">' + row[2] + '</div></div>'
                    },
                    "createdCell": function (td, cellData, rowData, row, col) {
                        $(td).addClass('img');
                    }
        ...
        const dt = $('#friends table.table-datatable2').DataTable($.extend(true, {}, dtDefaultOptions, {
            ...
            "columnDefs": [
                // Icon / Friend
                {
                    "targets": 0,
                    "render": function (data, type, row) {
                        return '<div class="icon-name"><div class="icon"><img data-lazy="' + row[2] + '" class="rounded square" data-src="/assets/img/no-player-image.jpg" data-lazy-alt="' + row[3] + '"></div><div class="name">' + row[3] + '</div></div>'
                    },
                    "createdCell": function (td, cellData, rowData, row, col) {
                        $(td).addClass('img');
                    },
