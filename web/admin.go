...
func adminDev() {
	...
	db.FlushBufferToDatastore()
	return

	var allIDs = []int{338131, 343093, 342199, 342198, 308489, 305020, 305019, 303006, 303005, 294662, 288880, 288879, 288876, 288875, 288840, 288839, 288810, 288809, 284905, 278724, 261959, 261958, 261712, 255592, 250886, 246087, 246086, 245499, 245498, 190252, 190251, 184115, 183675, 183674, 183453, 183450, 183447, 183444, 180958, 177338, 172243, 172242, 171860, 171856, 171852, 171848, 171844, 171840, 171836, 171832, 171108, 164007, 155359, 154706, 154117, 153770, 153767, 150818, 143516, 136389, 126555, 121351, 98980}

	for _, v := range allIDs {
		err := queue.ProducePackage(v)
		log.Err(err)
	}
